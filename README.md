...
* **🔍 วิเคราะห์ผลลัพธ์**
    * *Sequential:* เวลาที่ใช้ คือ 8.18, 9.95, 10.37 วินาที เป็นผลรวมเวลา ของแต่ละรอบ โดยจะเป็นการโหลดทุกเมืองรวมกัน (T1 + T2 + T3 + T4 + T5)และค่าเฉลี่ย คือ 9.5 วินาที
    * *Threading:* เวลาที่ใช้ คือ 2.63, 2.99, 1.94 วินาที เวลาที่ใช้จะเท่ากับระยะเวลาของเมืองที่โหลดนานที่สุดเพียงเมืองเดียว 
