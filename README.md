...
* **สิ่งที่ทำ:** โปรแกรมจะจำลองการขอข้อมูลสภาพอากาศจาก 5 เมือง (เช่น Bangkok, Tokyo, London, New York, Paris) โดยใช้ `time.sleep()` เป็นตัวแทนของเวลาที่ใช้ในการรอเน็ตเวิร์ค
...
<table>
  <tr>
    <td><img src="sequential_weather1.png" width="300"></td>
    <td><img src="threading_weather1.png" width="300"></td>
  </tr>
  <tr>
    <td><img src="sequential_weather2.png" width="300"></td>
    <td><img src="threading_weather2.png" width="300"></td>
  </tr>
    <tr>
    <td><img src="sequential_weather3.png" width="300"></td>
    <td><img src="threading_weather3.png" width="300"></td>
  </tr>
</table>

* **🔍 วิเคราะห์ผลลัพธ์**
    * *Sequential:* เวลาที่ใช้ คือ 8.18 วินาที เป็นผลรวมของเวลาโหลดทุกเมืองรวมกัน (T1 + T2 + T3 + T4 + T5)
    * *Threading:* เวลาที่ใช้จะเท่ากับระยะเวลาของเมืองที่โหลดนานที่สุดเพียงเมืองเดียว 
    (ในที่นี้คือ Bangkok ที่ใช้เวลา 2.63 วินาที) เนื่องจากทุกเมืองเริ่มโหลดพร้อมกัน
